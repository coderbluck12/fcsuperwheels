...
<head>
  ...
  <title>All Receipts | FC Superwheels</title>
  ...
  <style>
    ...
    .page-topbar h1 i { color: var(--primary); }
    ...
    .perpage-select select:focus { outline: none; border-color: var(--primary); }
    ...
    .nav-btn:hover:not(:disabled) { background: var(--gray-100); border-color: var(--gray-400); }
    ...
    .receipts-table tbody tr:hover { background: var(--gray-50); }
    ...
    .btn-view, .btn-edit-r, .btn-delete-r {
      display: inline-flex;
      align-items: center;
      gap: 0.25rem;
    ...
    .btn-view:hover { background: #dbeafe; color: var(--primary-dark); text-decoration: none; }

    .btn-edit-r { background: #fef3c7; color: var(--warning); }
    .btn-edit-r:hover { background: #fde68a; color: #b45309; text-decoration: none; }

    .btn-delete-r { background: #fee2e2; color: var(--danger); }
    .btn-delete-r:hover { background: var(--danger); color: white; }
    ...
    .page-num:hover { background: var(--gray-100); border-color: var(--gray-300); text-decoration: none; }
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-group">
                        <a href="view_receipt.php?prefix_receipt_number=<?= $key ?>" class="btn-view">
