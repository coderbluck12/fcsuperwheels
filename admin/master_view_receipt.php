...
<div class="invoice-box">
    ...
    <div class="footer text-center mt-4">
        ...
        <div class="mt-3 noprint">
            ...
            <a class="btn-edit" href="mastermodifyreceipt.php?prefix_receipt_number=<?= urlencode($encrypted_id); ?>">Edit Receipt</a>
            <a class="btn-delete" href="#" onclick="confirmDelete('master_delete_receipt.php?prefix_receipt_number=<?= urlencode($encrypted_id); ?>'); return false;">Delete Receipt</a>
            <a class="btn-close" href="master_view_all_receipts.php">Close</a>
        </div>
    </div>
</div>
